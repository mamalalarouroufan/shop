...
public class XSSSecurityConstants {
	 ...
	 */
	public static String FILTER_ERROR_PAGE = "/403";

	public static String REPLACE_1 = "1"; //替换
	public static String REPLACE_2 = "2"; //转码
	
	public static String INGORE_URL = "ignoreUrl";
}
