...
public class ReceiveEventMessage {
	...
	private Integer filterCount;// 过滤（过滤是指特定地区、性别的过滤、用户设置拒收的过滤，用户接收已超4条的过滤）后，准备发送的粉丝数，原则上，FilterCount
	...
	public String toString() {
		return "ReceiveEventMessage [toUserName=" + toUserName + ", fromUserName=" + fromUserName + ", createTime="
				...
				+ ", msgId=" + msgId + ", content=" + content + ", picUrl=" + picUrl + ", mediaId=" + mediaId
				+ ", format=" + format + ", recognition=" + recognition + ", thumbMediaId=" + thumbMediaId
				...
				+ ", errorCount=" + errorCount + ", expiredTime=" + expiredTime + ", failTime=" + failTime
