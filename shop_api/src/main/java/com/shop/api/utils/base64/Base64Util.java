package com.shop.api.utils.base64;
...
public class Base64Util {
	 ...
	 */
	public static String decodeDecrypt(String str) throws UnsupportedEncodingException{
		//字符串解密 进行解密
		byte[] oldStr = Base64Util.decode(str);
		String newStr = new String(oldStr, "UTF-8");
		return newStr;
	}
}
